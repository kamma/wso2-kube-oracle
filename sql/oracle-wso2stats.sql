ALTER SESSION SET CURRENT_SCHEMA=wso2stats;

DROP TABLE API_REQUEST_SUMMARY;
DROP TABLE API_VERSION_USAGE_SUMMARY;
DROP TABLE API_RESOURCE_USAGE_SUMMARY;
DROP TABLE API_RESPONSE_SUMMARY;
DROP TABLE API_FAULT_SUMMARY;
DROP TABLE API_DESTINATION_SUMMARY;
