...
echo 'going to change ownership of <AMA_HOME>/repository/database/ama/ directory: '
echo "user: ${USER}"
echo "user home: ${USER_HOME}"
echo "carbon server: ${WSO2_SERVER}-${WSO2_SERVER_VERSION}"

/bin/chown -R ${USER} ${USER_HOME}/${WSO2_SERVER}-${WSO2_SERVER_VERSION}/repository/database/ama/
/bin/chgrp -R root ${USER_HOME}/${WSO2_SERVER}-${WSO2_SERVER_VERSION}/repository/database/ama/
/bin/chmod -R 777 ${USER_HOME}/${WSO2_SERVER}-${WSO2_SERVER_VERSION}/repository/deployment/server

echo 'going to change ownership of <AMA_HOME>/repository/logs directory: '
echo "user: ${USER}"
echo "user home: ${USER_HOME}"
echo "carbon server: ${WSO2_SERVER}-${WSO2_SERVER_VERSION}"
